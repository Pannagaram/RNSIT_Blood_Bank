...
<head>
	...
	<title>RNSIT Blood Bank | Forgot Password</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">RNSIT Blood Bank </h1>
						<h1 class="text-center text-bold text-light mt-0x"> Forgot Password</h1>
