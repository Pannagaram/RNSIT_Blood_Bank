...
<head>
	<title>RNSIT Blood bank | Home Page</title>
			...
			<ul class="rslides callbacks callbacks1" id="slider4">
				<li>
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>The Power of Red:
									<span> Give Blood, Give Life.</span>
								</h3>
				...
				<li>
					<div class="banner-top2">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								<h3>From Heart to Heart:
									<span> Support the Blood Bank Movement</span>
								</h3>
...
<p>AB positive or AB negative.</p><br>
                </ul>
